...
def process_ocr_task(image_path, image_content_type, expected_values):
    """Process OCR task.
    ...
    with open(image_path, "rb") as f:
        image_file = f.read()
    temp_image_path, predictions = segment_image(image_file, roboflow_client)
    ...
    ai_msg = llm_invoker.invoke(input_prompt, image_content_type, segmented_image_base64)
